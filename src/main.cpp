...
int keyIndex = 0;
// 快捷键文字描述列表
String arrKeyTitle[] = {"播放、暂停", "静音", "Ctrl + V", "Shift键", "生成解决方案", "VS注释代码", "切换桌面"};

int arrKeyCode[][3] = { // -1表示此位置无按键，为了演示追求代码简洁（用list来表示快捷键逻辑更清晰且易扩展）
                        {8, 0,          -1},
                        {16, 0,          -1},
                        {KEY_LEFT_CTRL,   'v',          -1},
                        {KEY_LEFT_SHIFT,  -1,           -1},
...
#define BUTTON_1 23       // 我把按钮接在开发板的27号引脚，可根据自己情况修改
